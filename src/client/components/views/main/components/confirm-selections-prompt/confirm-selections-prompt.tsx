      ...
      <div className={STYLES.inner} onClick={NO_BUBBLE}>
        <Panel>
          ...
          <ol>
            ...
            <li>
              All raiders must maintain ONE alternative character to within a reason of their main, this is important for a number of reasons, which can be explained if you contact an officer.
            </li>
            <li>
              The calendar will work in the following way - Sign up to raids at your earliest convinience. Try not to forget, as this will strongly hinder the planning for raids.
              <ul>
                <li>Confirmed = Confirmed a spot for raid and expected to attend</li>
                <li>Standby = Expected to show up at beginning of raid, incase of drop-outs</li>
                <li>Out = Not needed for current raid night</li>
                <li>Invited = Player has not checked calendar, everyone please remind.</li>
              </ul>
            </li>
          </ol>
