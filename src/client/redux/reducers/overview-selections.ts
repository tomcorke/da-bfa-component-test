...
import { LockSelectionChoice, PlayerSelectionChoice } from "../../../types/api";
...
const selectChoice = (
  ...
  { battletag, playerChoice, selectionChoice }: SelectedChoice
...
const OverviewSelectionsReducer: Reducer<
  OverviewSelectionsState,
  overviewSelectionsActions.OverviewSelectionsActions
